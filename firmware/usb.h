...
extern u8 usbd_control_buffer[USB_CONTROL_BUFFER_SIZE];
extern usbd_device *usbd_dev;
extern char usb_buf[64];
...
int cdcacm_control_request(usbd_device *usbd_dev, struct usb_setup_data *req, u8 **buf, u16 *len, void (**complete)(usbd_device *usbd_dev, struct usb_setup_data *req));
